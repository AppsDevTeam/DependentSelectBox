...
trait DependentTrait
{
	...
	public function getControl() : Nette\Utils\Html
	{
		...
		$attrs['data-dependentselectbox'] = $form->getPresenter()->link($this->lookupPath('Nette\\Application\\UI\\Presenter') . Nette\ComponentModel\IComponent::NAME_SEPARATOR . self::SIGNAL_NAME . '!', new Nette\Http\Url($form->getAction())->getQueryParameters());
